...
def train(args):
    ...
    batch_size = int(args.num_processes * args.num_steps / args.num_mini_batch) # 2048
    ...
    for j in range(init_epoch, num_updates):
        ...
        with torch.no_grad():
            ...
            next_value = actor_critic.get_value(obs_id,rollouts.recurrent_hidden_states[-1],rollouts.masks[-1]).detach()
